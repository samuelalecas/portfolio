...
export const ProjectCard: React.FC<ProjectProps> = ({title, description}) => {
  return (
    <article className="relative col-span-1 h-64 border-2 border-blue-950 rounded-md hover:scale-105 transition duration-100 opacity-90 hover:opacity-100 hover:cursor-pointer hover:shadow-xl">
